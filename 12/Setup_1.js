    ...
    var Generator = {sx: 20, sy: 20, mineMax: 6, amount:[10,10,10,10,10,10], shape:Shape_Normal, wrap:[0,0]};
    ...
    var counterDisplay = {
      ...
      Mines:[{
        ...
        c:0,
        t:0,
        div_sec:document.getElementById('count_sec_4flag'),
        div_tex:document.getElementById('count_tex_4flag')
      },{
        c:0,
        t:0,
        div_sec:document.getElementById('count_sec_5flag'),
        div_tex:document.getElementById('count_tex_5flag')
      },{
        c:0,
        t:0,
        div_sec:document.getElementById('count_sec_6flag'),
        div_tex:document.getElementById('count_tex_6flag')
      }],
      AntiMines:{
        c:0,
        t:0,
