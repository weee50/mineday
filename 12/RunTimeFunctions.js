...
function clearCounters(){
  ...
  counterDisplay.Mines[3].c = 0;
  counterDisplay.Mines[4].c = 0;
  counterDisplay.Mines[5].c = 0;
...
function updateCounterDisplay(){
  ...
  printSingleCounter(counterDisplay.Mines[3]);
  printSingleCounter(counterDisplay.Mines[4]);
  printSingleCounter(counterDisplay.Mines[5]);
